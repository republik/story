...
export const bigQuestionData: InputData = {
  question: "Was wünschten Sie, würden alle über die Klimakrise verstehen?",
  answers: [
    {
      category: {
      ...
      answers: [
...

        {
          respondent: {
            ...
            title: "Klimatologe",
            description:
              "Professor für Atmosphären­wissenschaften an der University of Pennsylvania. Mitarbeit an den Berichten des Weltklimarats (IPCC) sowie Autor von «<a href='https://www.oekom.de/buch/moment-der-entscheidung-9783987260698' target='_blank'>Moment der Entscheidung</a>» (2024)",
            avatarUrl: {
              thumb:
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          respondent: {
            name: "Wolfgang Blau",
            title: "Publizist und Experte für Klimakommunikation",
            description:
              "Geschäftsführender Partner bei der PR-Agentur Brunswick Group und Mitgründer des <a href='https://reutersinstitute.politics.ox.ac.uk/oxford-climate-journalism-network' target='_blank'>Oxford Climate Journalism Network</a>",
            avatarUrl: {
              thumb:
                "https://cdn.repub.ch/s3/republik-assets/repos/republik/article-was-taugt-das-1-5-grad-ziel-noch/files/7ea85fbf-e3ae-4d43-8cbf-0c519507e226/170_wolfgang-blau_bw.jpg",
              normal:
                "https://cdn.repub.ch/s3/republik-assets/repos/republik/article-was-taugt-das-1-5-grad-ziel-noch/files/e26507cc-7eec-424b-a09c-cd1d214059b6/600_wolfgang-blau_bw.jpg",
            },
          },
          quote:
