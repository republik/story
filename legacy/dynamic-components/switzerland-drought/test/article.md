...
```
{
  ...
  "props": {
    "anchor": "plot",
    "title": "Dürre in der Schweiz",
    "lead": "Wie kam es dazu?",
    "phases": [
      {
        "title": "Trockenheit im Winter",
         "step": "step1"
      },
      {
        "title": "Hitze im Mai",
      ...
      {
        "title": "Trockenheit in den Sommermonaten",
        "step": "step3"
      },
      {
        "title": "Hitze und Trockenheit im Jahr 2022",
        "step": "step4"
      }
    ],
    "translations": [
      {
        "key": "step1/text",
        "value": "Es war irre trocken und zwar schon früh. Im Tessin fehlte der Niederschlag. Die Berge blieben kahl. {municipality_winter}"
      },
      {
        "key": "step1/municipality_winter",
        "value": "In {municipality} gab es {winter_diff} weniger Niederschlag als in der Normperiode von 1991 bis 2020."
      },
      {
        "key": "step2/text",
