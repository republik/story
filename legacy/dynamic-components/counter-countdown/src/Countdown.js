...
const Countdown = ({ t, endDate, caption, over }) => {
    ...
    <P {...colorScheme.set('color', 'text')}>
      ...
      >
        {isRunning
          ? [
              days > 0 &&
                t.pluralize('countdown/time/days', {
                  count: days,
                }),
              (days !== 0 || hours > 0) &&
                t.pluralize('countdown/time/hours', {
                  count: hours,
                }),
              t.pluralize('countdown/time/minutes', {
                count: minutes,
              }),
              days === 0 &&
                hours === 0 &&
                lastUpdate &&
                t.pluralize('countdown/time/seconds', {
...
export default compose(withTranslations)(Countdown)
