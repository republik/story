...
```
{
  ...
  "props": {
    "slug": "mss-demokratie",
    "caption": "Ihrer Kolleginnen und Kollegen haben geantwortet.",
    "showCountdown": true,
    "countdownCaption": "bis zum Ende der Befragung",
    "countdownOverMessage": "Die Befragung ist abgelaufen"
  },
  "src": "https://cdn.repub.ch/s3/republik-assets/dynamic-components/counter-countdown/index.js"
}
```
