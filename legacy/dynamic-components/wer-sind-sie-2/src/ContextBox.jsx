...
import { Interaction, fontStyles, useColorContext } from '@project-r/styleguide'
...
const ContextBox = ({ orientation: yOrientation, x, y, children }) => {
  const xOrientation = 'center'
  const [colorScheme] = useColorContext()
