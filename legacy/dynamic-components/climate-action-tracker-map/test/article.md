...
```
{
  ...
  "size": "breakout",
  "props": {
    "title": "Alle Industrieländer verstossen gegen das globale Klimaabkommen",
    "lead": "Bewertung der Kompatibilität von nationalen Klimamassnahmen und -zielen mit dem Pariser Abkommen",
    "footnote": "Wenn Sie ein Land antippen, sehen Sie jeweils den aktuellen Status. Und wenn Sie die Boxen unter dem Titel anklicken, sehen Sie die betreffenden Länder."
  },
  "src": "https://cdn.repub.ch/s3/republik-assets/dynamic-components/climate-action-tracker-map/index.js"
}
```
