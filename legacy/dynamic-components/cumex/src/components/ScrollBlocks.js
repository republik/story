...
import BGerNordea from './BGerNordea'
import RRFE from './RRFE'
...
class Story extends Component {
  ...
  render () {
    ...
    const { phases, schema, anchor } = this.props
              ...
              return <Fragment key={key}>
                ...
                <div {...styles.scrollBlock} ref={this.blocks[key].setRef}>
                  ...
                  <RawHtml type={P} dangerouslySetInnerHTML={{
                    __html: phase.html.replace(/{BANK_NAME}/g, BANK_NAME)
                  }} />
                </div>
              </Fragment>
            })}
