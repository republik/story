...
import { createArticleSchema, createRequire } from '@project-r/styleguide'
...
// import md from '../article-eth.md'
// import md from '../article-kilmawandel.md'
import md from '../article-brands.md'
