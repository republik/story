...
const styles = {
  ...
  scrollBlock: css({
    ...
    [mediaQueries.mUp]: {
      ...
      width: 350, // make text box little bit wider than usual text flow
    },
  }),
  artboard: css({
            ...
            >
              <div>
                <ImageFader
                  ...
                  foregroundImage={this.props.foregroundImage}
                        ...
                        <ChartLead key={i}>
                          {t.elements(text, {
                            link: (
                              <Link
                                key={`url-${i}`}
                                text={t(phase.step + '/linkText')}
                                href={t(phase.step + '/linkUrl')}
                              />
                            ),
                          })}
                        </ChartLead>
