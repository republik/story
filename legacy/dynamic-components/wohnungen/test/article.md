...
```
{
  ...
  "props": {
    ...
    "color": "red",
    "maxWidth": 1502,
    "image": "https://cdn.republik.space/s3/republik-assets/assets/zh-immos/all_investors_2.png",
    "scaling": [0.4, 0.7],
    "mobileLegendBottom": true,
    "description": "Adressen sind in Besitz von 26 Grossinvestoren",
    "legend": "Quelle: Angaben der Unternehmen, Grundbuchämter der Stadt Zürich"
  },
  "src": "https://cdn.repub.ch/s3/republik-assets/dynamic-components/wohnungen/index.js"
}
```
