...
```
{
  "autoHtml": false,
  "props": {
    "image": "neue_schweiz.png",
    "title": "Die stabilen Kantone",
    "lead": "Ständeräte, 1971 bis 2019",
    "source": "Quelle: Eigene Berechnungen",
    "annotationColumn": "Appenzell Ausserrhoden",
"filterList": ["Basel-Stadt", "Appenzell Ausserrhoden", "Aargau", "Appenzell Innerrhoden", "Graubünden", "Luzern", "Jura", "Glarus", "Schaffhausen", "Thurgau", "Uri", "Wallis", "Zürich"],
    "annotations": [
      {
        "mirror": true,
        "label": "2019",
  ...
  "src": "https://cdn.repub.ch/s3/republik-assets/dynamic-components/map-color-legend/index.js"
}
```
