...
```
{
  ...
  "props": {
    "type": "Pleading",
    "discussionId": "ded9c4fd-aafc-4e91-91a3-6d102591c357",
    "translations": [
      {
        "key": "styleguide/CommentComposer/placeholder",
        "value": "Ein Plädoyer verfassen…"
      },
      {
      ...
      },
      {
        ...
        "value": "Es können keine neuen Plädoyers mehr eingegeben werden."
      }
    ],
    "orderBy": "DATE",
    "tagMapping": {
  ...
  "src": "https://cdn.repub.ch/s3/republik-assets/dynamic-components/pleadings/index.js"
}
```
